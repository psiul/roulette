...
where ss.ss_cdemo_sk = cd.cd_demo_sk and ss.ss_sold_date_sk = d.d_date_sk and ss.ss_hdemo_sk = hd.hd_demo_sk and ss.ss_customer_sk = c.c_customer_sk and c.c_current_addr_sk = a.ca_address_sk and ss.ss_item_sk = i.i_item_sk and d.d_hash >= 186 and d.d_hash <= 936 and hd.hd_hash >= 497 and hd.hd_hash <= 897 and a.ca_hash >= 533 and a.ca_hash <= 866
;
