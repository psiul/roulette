...
where ss.ss_customer_sk = c.c_customer_sk and c.c_current_addr_sk = a.ca_address_sk and ss.ss_cdemo_sk = cd.cd_demo_sk and c.c_current_hdemo_sk = hd.hd_demo_sk and ss.ss_item_sk = i.i_item_sk and ss.ss_sold_date_sk = d.d_date_sk and c.c_hash >= 48 and c.c_hash <= 381 and a.ca_hash >= 355 and a.ca_hash <= 755 and cd.cd_hash >= 91 and cd.cd_hash <= 841
;
