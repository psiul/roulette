...
def init_graph(schema) : 
	...
	highborder = random.sample(high,8)
...
clustersize = size/2
relerror = pow(3, 1.0/(size/2))

highcentroid = targetsel*2
lowcentroid = targetsel/2
...
#generate_microbenchmark(dims, joins, "/d16joins-" + str(joins-1) + "-" + str(size))
